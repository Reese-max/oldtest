...
class AIQuestionParser:
    ...
    def _detect_question_groups_enhanced(self, text: str) -> List[Dict[str, Any]]:
        ...
        for pattern in patterns:
            ...
            for match in matches:
                ...
                groups.append({"start": start_num, "end": end_num, "context": context, "pattern": pattern})
    ...
    def _parse_question_group_enhanced(
        self, text: str, start_num: int, end_num: int, context: str = ""
    ) -> List[Dict[str, Any]]:
        """增強的題組解析"""
        questions = []
        ...
        option_columns = [CSV_COLUMN_OPTION_A, CSV_COLUMN_OPTION_B, CSV_COLUMN_OPTION_C, CSV_COLUMN_OPTION_D]
    ...
    def _parse_regular_questions_enhanced(self, text: str, exclude_nums: set) -> List[Dict[str, Any]]:
        """增強的一般題目解析"""
        questions = []
