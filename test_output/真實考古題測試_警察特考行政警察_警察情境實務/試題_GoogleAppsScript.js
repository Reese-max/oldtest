 ...
 * 考古題練習表單生成器
 * 自動從CSV資料建立Google表單
 * 生成時間: 2025-10-15 16:14:42
 */

function createPracticeForm() {
  // 表單設定
  const formTitle = "考古題練習表單";
  const formDescription = "此表單包含 15 題考古題，用於練習和自測";
  ...
  const questions = [
    {
      ...
      optionA: "二、你是派出所所長，帶班巡邏獲報轄內有酒駕事故發生，到達現場後對肇",
      optionB: "事駕駛人進行酒測，依所測得吐氣酒精濃度值結果，酒駕肇事駕駛人移",
      optionC: "nan",
      optionD: "nan",
      category: "其他",
      difficulty: "中等",
    ...
    {
      title: "號判決，\n就道路交通管理處罰條例第",
      optionA: "就道路交通管理處罰條例第",
      optionB: "號判決， 就道路交通管理處罰條例第",
      optionC: "nan",
      optionD: "nan",
      category: "其他",
      difficulty: "簡單",
    ...
    },
    {
      ...
      optionA: "項，有關對汽車肇事駕駛人強制",
      optionB: "實施血液或其他檢體之採樣及測試檢定，宣告違憲，現階段若汽車駕駛",
      optionC: "人肇事拒絕接受或無法實施吐氣酒精濃度測試之檢定，內政部警政署對",
      optionD: "nan",
      category: "其他",
      difficulty: "中等",
      isGroup: False,
    },
    {
      ...
      optionA: "三、你是分局偵查隊長，轄內某日發生知名幫派分子甲於住家門前遭不詳歹",
      optionB: "徒埋伏槍擊，歹徒隨即逃逸無蹤，你接獲勤務指揮中心通知立刻趕至現",
      optionC: "場，發現派出所同仁已將現場封鎖保全，被害人送醫急救中，請問你應",
      optionD: "nan",
      category: "其他",
      difficulty: "困難",
      isGroup: False,
    ...
    },
    {
      ...
      optionA: "值班員警受理民眾甲女報案遭受跟蹤騷擾案，如果你是值班員警，甲女報案之下列敘述內容，何",
    ...
    },
    {
      ...
      optionA: "你是派出所所長，在你的轄區治安要點有設置錄影監視系統，民眾甲（案件關係人）陳情，需要",
      optionB: "調閱監視系統之影音檔案，依據「治安要點錄影監視系統調閱影像檔案處理作業程序」之規定，",
    ...
    },
    {
      ...
      optionC: "被害人胸部中槍大量出血，救護車送醫過程，應派員隨同上車，並交付儘可能了解案情及記錄",
      optionD: "現場派員實施封鎖、警戒，對駐足圍觀群眾全面錄影，記錄周邊人車資料，並指定專人立即調",
      category: "其他",
      difficulty: "困難",
      isGroup: False,
    },
    {
      ...
      optionA: "鑒於現今社會詐欺案件居高不下，嚴重影響民眾財產安全，究其原因係犯罪集團透過政府相關部",
      optionB: "門的管制措施不足所致，因此，行政院於民國",
      optionC: "nan",
      optionD: "nan",
      category: "其他",
      difficulty: "中等",
    ...
    },
    {
      ...
      optionA: "日核定「新世代打擊詐欺策略行動",
      optionB: "綱領」，成立「打詐國家隊」，由各機關協力打擊詐騙犯罪，針對協力偵防之策略，下列敍述何",
      optionC: "識詐（宣導教育面）由內政部擔任統籌機關，強化分層、分眾、分齡犯罪預防宣導工作，提升",
      optionD: "民眾防詐免疫力",
      category: "其他",
      difficulty: "困難",
      isGroup: False,
    },
    {
      ...
      optionA: "你處理一起汽車駕駛人甲因拒絕接受酒精濃度測試經強制抽血檢測之案件，同車乘客乙與丙分別",
    ...
    {
      title: "如果你是一位派出所所長，參加社區治安會議，轄內居民反映其所住社區前方交岔路口",
      optionA: "如果你是一位派出所所長，參加社區治安會議，轄內居民反映其所住社區前方交岔路口",
      optionB: "如果你是一位派出所所長，參加社區治安會議，轄內居民反映其所住社區前方交岔路口",
      optionC: "nan",
      optionD: "nan",
      category: "其他",
      difficulty: "簡單",
    ...
    {
      title: "公尺內違規停車不在可檢舉之項目內，請民眾一律撥打110通知警方到場",
      optionA: "公尺內違規停車不在可檢舉之項目內，請民眾一律撥打110通知警方到場",
      optionB: "公尺內違規停車不在可檢舉之項目內，請民眾一律撥打110通知警方到場",
      optionC: "nan",
      optionD: "nan",
      category: "其他",
      difficulty: "簡單",
    ...
    },
    {
      ...
      optionA: "派出所所長甲於主持勤前教育時，向所屬宣達駕駛警備車於開啟警示燈及警鳴器執行「緊急任務」",
      optionB: "時，依法可不受標誌、標線及號誌的限制，惟仍應顧及行人及其他車輛安全；警員乙詢問甲「何",
      optionC: "執行專案勤務、路檢及重點巡邏任務",
      optionD: "緝捕現行犯、逃犯",
      category: "其他",
      difficulty: "困難",
      isGroup: False,
