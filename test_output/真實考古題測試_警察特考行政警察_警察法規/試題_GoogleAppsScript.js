 ...
 * 考古題練習表單生成器
 * 自動從CSV資料建立Google表單
 * 生成時間: 2025-10-15 16:14:40
 */

function createPracticeForm() {
  // 表單設定
  const formTitle = "考古題練習表單";
  const formDescription = "此表單包含 18 題考古題，用於練習和自測";
...
function addQuestionsToForm(form) {
  const questions = [
    {
      title: "分）並請論述其規範及內容是\n否存在值得商榷之處？（",
      optionA: "分）並請論述其規範及內容是",
      optionB: "分）並請論述其規範及內容是 否存在值得商榷之處？（",
      optionC: "nan",
      optionD: "nan",
      category: "其他",
      difficulty: "簡單",
    ...
    },
    {
      ...
      optionB: "具名不具銜兼任公職候選人競選辦事處之職務",
      optionC: "登記為公職候選人，並自候選人名單公告之日起請事假",
      optionD: "nan",
      category: "其他",
      difficulty: "中等",
      isGroup: False,
    },
    {
      ...
      optionA: "公法上金錢給付義務之執行 行為或不行為義務之執行",
      optionB: "身分查證之詢問 即時強制",
      optionC: "nan",
      optionD: "nan",
      category: "其他",
      difficulty: "中等",
    ...
    },
    {
      ...
      optionD: "所蒐集集會、遊行參與者之資料，得為調查犯罪或其他違法行為，而延長保存",
      category: "其他",
      difficulty: "困難",
      isGroup: False,
    },
    ...
    },
    {
      ...
      optionB: "因其僅具建議及勸導之性質，故是否要解散，參加人得自行決定",
      optionC: "得向主管機關表達異議",
      optionD: "nan",
      category: "其他",
      difficulty: "困難",
    ...
    },
    {
      ...
      optionA: "未成年 褫奪公權尚未復權",
      optionB: "受監護之宣告，尚未撤銷 無中華民國國籍",
      optionC: "nan",
      optionD: "nan",
      category: "其他",
      difficulty: "中等",
    ...
    },
    {
      ...
      optionA: "本項職權是對於私人住宅、建築物或處所之進入",
      optionB: "進入時應著制服或出示證件表明身分，並應告知事由",
      optionC: "有賭博或其他妨害風俗或公安之情事，於情況急迫時得進入制止",
    ...
    },
    {
      ...
      optionB: "期間每次不得逾一年，如有必要得延長之，並以一次為限",
      optionC: "經由警察分局長書面同意後始得實施",
      optionD: "僅得對其無隱私或秘密合理期待之行為或生活情形進行觀察及動態掌握",
      category: "其他",
      difficulty: "困難",
      isGroup: False,
    },
    ...
    },
    {
      ...
      optionA: "司法院釋字第718號解釋認為，集會遊行法第8條第1項規定，室外集會、遊行應向主管機關",
      optionB: "申請許可，未排除緊急性及偶發性集會、遊行部分，違反比例原則",
      optionC: "司法院釋字第",
      optionD: "nan",
      category: "法律",
      difficulty: "困難",
    ...
    {
      title: "號解釋認為，社會秩序維護法第",
      optionA: "號解釋認為，社會秩序維護法第",
      optionB: "號解釋認為，社會秩序維護法第",
      optionC: "nan",
      optionD: "nan",
      category: "其他",
      difficulty: "簡單",
    ...
    },
    {
      ...
      optionA: "條就意圖得利與人姦、宿者，對於從事",
      optionB: "性交易之行為人，僅以意圖得利之一方為處罰對象，與平等原則有違",
      optionC: "司法院釋字第",
      optionD: "nan",
      category: "其他",
      difficulty: "中等",
    ...
    },
    {
      ...
      optionA: "款規定，使新聞採訪者之跟追行",
      optionB: "為受到限制，違反比例原則",
      optionC: "nan",
      optionD: "nan",
      category: "其他",
      difficulty: "簡單",
    ...
    },
    {
      ...
      optionA: "號判決認為，警察人員人事條例規定警察人員同一考績年度中，其平時考",
      optionB: "核獎懲互相抵銷後累積已達二大過應予以免職，與憲法保障人民平等服公職權尚無牴觸",
      optionC: "nan",
      optionD: "nan",
      category: "法律",
      difficulty: "中等",
