...
class TestCSVGeneratorExtended(unittest.TestCase):
    ...
    def test_generate_questions_csv_with_answers(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            result = self.generator.generate_questions_csv(self.test_questions, self.test_answers, output_path)
    ...
    def test_generate_question_groups_csv(self):
        """測試生成題組分類CSV"""
        with tempfile.TemporaryDirectory() as temp_dir:
            csv_files = self.generator.generate_question_groups_csv(self.test_questions, self.test_answers, temp_dir)
    ...
    def test_calculate_difficulty_levels(self):
        ...
        hard_q = {
            "題目": "這是一個非常長的題目，包含大量內容和詳細描述，用來測試困難級別的題目難度計算功能，確保系統能夠正確識別不同難度題目"
            * 2
        }
    ...
    def test_generate_csv_with_empty_questions(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            result = self.generator.generate_questions_csv([], {}, output_path)
    ...
    def test_generate_csv_with_missing_answers(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            # 沒有提供答案
            result = self.generator.generate_questions_csv(self.test_questions, {}, output_path)
